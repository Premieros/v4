...
- لا نحتفظ بملف `full_schema.sql` أو Snapshot موازٍ للمهاجرات؛ أي Snapshot كامل قابل للتقادم ولا يُعد مصدر حقيقة.
...
هذا المستودع مرتبط حصريًا بمشروع Supabase ذي المرجع `cuitndfayupfysejlpda`.
سكربتات التطبيق والتحقق والـCI ترفض أي Supabase project آخر، مع السماح بـ`localhost`/`127.0.0.1` فقط لاختبارات PostgreSQL المحلية.
